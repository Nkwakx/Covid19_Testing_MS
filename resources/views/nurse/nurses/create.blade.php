                            ...
                            <tbody>
                                @forelse ($test_logs as $log)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('nurse.nurses.store') }}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                <div data-repeater-list="group-a">
                                                    <div data-repeater-item class="row">
                                                        ...
                                                        <div class="col-auto float-right ml-auto">
                                                            <button type="submit" class="btn btn-primary btn-add-row"><i class="fa fa-plus"> Save</i></button>
                                                        </div>
                                ...
                                @empty
                                    <div class="req-item py-3 fw-bolder">Nothing to capture</div>
                                @endforelse
                            </tbody>
                        </table>
                </div>
