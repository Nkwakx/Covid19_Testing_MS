    ...
    <div class="page-header p-4 mb-0">
        <div class="row align-items-center">
            ...
            <div class="col-auto float-right ml-auto">
                <a href="{{ route('admin.users.create') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add
                    Patient</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($patients as $user)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->addressLine1 }} {{ $user->addressLine2 }}
                                        {{ $user->suburb->suburb_name ?? 'No Address' }}</td>
                                    <td>{{ $user->phone }}</td>
                                    <td>{{ $user->email }}</td>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body text-center">
                                                <form id="delete-user-form-{{ $user->id }}"
                                                    ...
                                                    @csrf
                                                    @method("DELETE")
                                                    <img src="{{ asset('images/sent.png') }}" alt="" width="50"
                                                        height="46">
