...
<div class="page-container">
    <div class="auth-form-title" style="background-image: url('{{ asset('images/auth.jpg') }}');">
        <span class="auth-form-title-1 py-4">
            Sign Up
        </span>
    </div>
                ...
                <div class="step-one">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ '/' }}" class="btn btn-secondary  btn-block btn-lg shadow-lg mt-3">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
